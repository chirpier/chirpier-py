...
from chirpier.client import ChirpierClientManager
from chirpier.event import Event
from chirpier.errors import ChirpierError


class TestChirpierClientManager(unittest.TestCase):
    """Tests for the ChirpierClientManager class."""
    ...
    def setUp(self):
        ...
        ChirpierClientManager.initialize(
